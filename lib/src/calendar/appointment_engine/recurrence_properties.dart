...
import 'package:flutter_datepicker/datepicker.dart' show IterableDiagnostics;
...
class RecurrenceProperties with Diagnosticable {
  ...
  RecurrenceProperties(
      ...
      : weekDays = weekDays ?? <WeekDays>[],
        ...
        assert(endDate == null || CalendarViewHelper.isSameOrBeforeDateTime(endDate, startDate)),
        assert(endDate == null || CalendarViewHelper.isSameOrAfterDateTime(startDate, endDate)),
        assert(interval >= 1),
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  int get hashCode {
    return Object.hash(recurrenceType, recurrenceCount, startDate, endDate, interval, recurrenceRange,
        Object.hashAll(weekDays), week, dayOfMonth, dayOfWeek, month);
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(EnumProperty<RecurrenceType>('recurrenceType', recurrenceType));
    properties.add(EnumProperty<RecurrenceRange>('recurrenceRange', recurrenceRange));
    properties.add(IterableDiagnostics<WeekDays>(weekDays).toDiagnosticsNode(name: 'weekDays'));
  }
}
