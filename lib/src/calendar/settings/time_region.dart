...
class TimeRegion with Diagnosticable {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(
        IterableDiagnostics<DateTime>(recurrenceExceptionDates).toDiagnosticsNode(name: 'recurrenceExceptionDates'));
    ...
    properties.add(DiagnosticsProperty<bool>('enablePointerInteraction', enablePointerInteraction));
  }
}
