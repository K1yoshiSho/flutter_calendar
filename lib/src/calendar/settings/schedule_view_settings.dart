...
class ScheduleViewSettings with Diagnosticable {
  ...
  const ScheduleViewSettings(
      ...
      this.placeholderText = 'No events',
      this.placeholderTextStyle = const TextStyle(color: Colors.grey, fontSize: 15)})
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(monthHeaderSettings.toDiagnosticsNode(name: 'monthHeaderSettings'));
    properties.add(weekHeaderSettings.toDiagnosticsNode(name: 'weekHeaderSettings'));
    properties.add(dayHeaderSettings.toDiagnosticsNode(name: 'dayHeaderSettings'));
    properties.add(DiagnosticsProperty<TextStyle>('appointmentTextStyle', appointmentTextStyle));
    properties.add(DoubleProperty('appointmentItemHeight', appointmentItemHeight));
    properties.add(DiagnosticsProperty<bool>('hideEmptyScheduleWeek', hideEmptyScheduleWeek));
    properties.add(DiagnosticsProperty<TextStyle>('placeholderTextStyle', placeholderTextStyle));
  }

  @override
  int get hashCode {
    return Object.hash(appointmentTextStyle, appointmentItemHeight, hideEmptyScheduleWeek, monthHeaderSettings,
        weekHeaderSettings, dayHeaderSettings, placeholderTextStyle);
  }
}
...
class MonthHeaderSettings with Diagnosticable {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<TextStyle>('monthTextStyle', monthTextStyle));
  ...
  @override
  int get hashCode {
    return Object.hash(monthFormat, height, textAlign, backgroundColor, monthTextStyle);
  }
}
...
class WeekHeaderSettings with Diagnosticable {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(DiagnosticsProperty<TextStyle>('weekTextStyle', weekTextStyle));
    properties.add(DoubleProperty('height', height));
    properties.add(EnumProperty<TextAlign>('textAlign', textAlign));
    properties.add(ColorProperty('backgroundColor', backgroundColor));
  ...
  @override
  int get hashCode {
    return Object.hash(startDateFormat, endDateFormat, height, textAlign, backgroundColor, weekTextStyle);
  }
}
...
class DayHeaderSettings with Diagnosticable {
  ...
  /// [SfCalendar].
  const DayHeaderSettings({this.dayFormat = 'EEE', this.width = -1, this.dayTextStyle, this.dateTextStyle})
      : assert(width >= -1);
